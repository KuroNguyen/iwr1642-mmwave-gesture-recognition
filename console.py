...
from mmwave.data.formats import Formats
from mmwave.data.gesture import GESTURE
from mmwave.data.logger import Logger
from mmwave.utils.flasher import Flasher
...
class Console(Cmd):
    ...
    def __get_user_rate(self, type, port):
        ...
        rates = []
        for rate in Connection.BAURATES:
            rates.append(str(rate))
